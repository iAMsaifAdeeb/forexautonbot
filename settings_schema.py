...
SETTINGS_SECTIONS = [
    ("Trading", [
        ...
        ("ladder_reversal_pips", "Dump cap (pips)", "int", "Max giveback from high/low before flip"),
        ("ladder_reversal_guard", "Park secure guard", "bool", "Opposite Stop = structure OR dump cap"),
        ("ladder_reversal_use_structure", "Guard uses swing", "bool", "Flip also on swing-low/high break"),
        ("ladder_stale_cancel_pips", "Cancel stale stops (pips)", "int", "Pullback size that cancels waiting same-side stops"),
        ("ladder_guard_after_wins", "Guard after N wins", "int", "Arm opposite guard only after this many TPs"),
