...
SETTINGS_SECTIONS = [
    ("Trading", [
        ...
        ("entry_mode", "Entry mode", "str", "hybrid or structure"),
        ("hybrid_tp_pips", "Hybrid TP (pips)", "int", "Fixed take-profit in pips"),
        ("hybrid_sl_pips", "Hybrid SL (pips)", "int", "Fixed stop-loss in pips"),
        ("hybrid_candle_bars", "Hybrid candle count", "int", "Aligned candles required"),
        ("basket_enabled", "Fable 5 basket", "bool", "Structure mode: 5-leg entries"),
