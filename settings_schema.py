...
SETTINGS_SECTIONS = [
    ("Trading", [
        ...
        ("ladder_dual_sides", "Dual grid (BUY+SELL)", "bool", "OFF recommended — uptrend must not park Sell Stops"),
        ("ladder_legs", "Stops per side", "int", "How many stops on the ACTIVE side only"),
        ("ladder_reversal_pips", "Reversal min giveback (pips)", "int", "Need this + opposing BOS before flip"),
        ("ladder_stale_cancel_pips", "Cancel stale stops (pips)", "int", "Pullback that cancels waiting SAME-side stops"),
